...
class _NearByPlacesScreenState extends State<NearByPlacesScreen> {
  ...
  double latitude =30.58768 ;
  double longitude = 31.502;
  ...
  void getNearbyPlaces() async {
    ...
    var url = Uri.parse('https://maps.googleapis.com/maps/api/place/nearbysearch/json?location=$latitude,$longitude&radius=$radius&type=hospital&key=$apiKey'
    );
